...
//     if (!name || !password) {
//       window.alert("Please fill in both your name and password to proceed.");
...
//       }
//     } else {
//       window.alert("An account already exists. Please log in instead.");
//       navigate("/login");
//     }
//   }
...
//       <div id="mysignup" className=" bg-slate-50 hover:bg-slate-200   text-gray-800 rounded-lg shadow-lg p-6 max-w-lg w-full">
